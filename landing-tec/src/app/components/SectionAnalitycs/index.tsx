    ...
    <section className="pt-16 xl:pt-24">
      <GridContainer>
        <div className="text-center mb-12 xl:mb-16">
          ...
          <h2 className="text-3xl lg:text-4xl font-semibold text-gray-900 mt-4 mb-6">
        ...
        <div className="relative w-full xl:max-w-[888px] h-auto xl:h-[561px] mx-auto mb-12 xl:mb-24">
          <Image
